...
public class MainFrame extends javax.swing.JFrame  {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(30, 30, 30))
                    .addComponent(btnClear, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)))
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(94, 94, 94)
    ...
    Validation validator = new Validation();
     ...
     //   String gender =buttonGender.getText();
        ...
        if (name.isEmpty()||email.isEmpty()||phone.isEmpty()||address.isEmpty() || !validatedPhone.equals(phone) || !validatedEmail.equals(email)) {
           ...
           if(rdMale.isSelected()){
            ...
            addRow(new Object[]{name, email, phone, address,g});
